<template>
  <div>
    ...
    <div class="container my-6">
      <softwareRelease :releaseData="mddata.releaseBlock" />
    </div>    
...
import softwareRelease from "@/components/softwareRelease";
export default {
  async asyncData({ app, $content }) {
    let mddata = await $content("pages/help/download/software/hdml-cloner-wand-helper-mobile-release").fetch();
...
layout:'primary',
components: {jumbotron,softwareRelease},
