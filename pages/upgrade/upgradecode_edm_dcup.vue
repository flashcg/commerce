...
<h4 v-if="mddata.orderInfo.deadline" class="text-center" v-text="mddata.orderInfo.deadline&&mddata.orderInfo.deadline.text"></h4>
  </div>
  <div class="py-6">
    <div class="container">
...
let  mddata = await $content('pages/upgrade/upgradecode_edm_dcup').fetch(),{upgrade} = await $content('pages/dvd-cloner/upgrade').fetch();
