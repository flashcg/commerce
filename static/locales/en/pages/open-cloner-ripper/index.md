...
areaTop:
  ...
  button:
    additionText: |
      <p class="lead"><img src="{imageUrl}/icon/disconut_icon.png" style="max-width:80px" class="mr-16"> <a class="text-light" href="https://www.dvd-cloner.com/special-offer-ocr2019-launch/" >Time-limited 50% OFF Special offer</a></p>
screenshot:
  name: Overview
  active: true
