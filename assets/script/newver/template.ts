...
const newverCode = (data: NewverData,listCode?:string) => {
  ...
  <html>
    ...
    <style type="text/css">
    body{background-color:${data.bgColor};color:${data.fontColor};font-size:12px;margin:0;padding:0;line-height:14px}img{border:0}a{text-decoration:underline}a:hover{text-decoration:none}.box{width:100%;font-family:Tahoma;overflow:hidden}.box_l{width:150px;float:left}.box_r{${data.button===false?'width:auto':'width:227px'};float:left}.clear{clear:both}.button{width:100%;padding-top:12px;text-align:center}.button a{display:inline-block;font-size:14px;font-weight:bolder;color:#FFF;padding-top:6px;padding-right:20px;padding-bottom:6px;padding-left:20px;text-decoration:none;margin-right:12px}a.download{background-color:#464646}a.buy{background-color:#921614}a.web{background-color:#005177}a.download:hover{background-color:#595959}a.buy:hover{background-color:#ad1512}a.web:hover{background-color:#006ea2}ul li{margin-bottom:4px}
    </style>
    </head><body scroll="no" border="0"><div class="box"><div class="box_l" align="center" style="padding-top:10px;text-align: left;${data.box===false?'display:none':''}"><img src="box.png" width="140" alt="" /></div><div class="box_h"><div class="box_r"><div class="list" style="margin-top: 10px;margin-left: 10px;">	<p><span style="font-weight: bolder;"> ${data.name} V${data.version} released.</span>		<br />		<span style="opacity: 0.5;">Release Date: ${data.date}</span></p>
            ${data.topText?'<p style="margin-top: 10px;">' + data.topText + '</p>':''}      		
        ${listCode}
    </div></div><div class="clear"></div></div><div class="button" style="${data.button===false?'display:none':''}">
